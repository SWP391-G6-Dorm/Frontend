...
public class VNPayService {
    ...
    public String createOrder(long total, String orderInfor, String urlReturn, String paymentId) {
        ...
        vnp_Params.put("vnp_Amount", String.valueOf(total * 100)); // amount in VND * 100
