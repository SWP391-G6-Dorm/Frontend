...
function StatusBadge({ status }: { status: string }) {
  const MAP: Record<string, { cls: string; label: string }> = {
    ...
    DRAFT:             { cls: 'badge-neutral', label: 'Nháp' },
    PENDING_APPROVAL:  { cls: 'badge-warning', label: 'Chờ duyệt' },
    APPROVED:          { cls: 'badge-success', label: 'Đã duyệt' },
    DISPUTED:          { cls: 'badge-warning', label: 'Khiếu nại' },
    PAID:              { cls: 'badge-success', label: 'Đã thanh toán' },
    CLEAN:             { cls: 'badge-success', label: 'Sạch' },
    AVAILABLE:         { cls: 'badge-success', label: 'Sẵn sàng' },
    OCCUPIED:          { cls: 'badge-info',    label: 'Đang ở' },
    MAINTENANCE:       { cls: 'badge-warning', label: 'Bảo trì' },
    PENDING_CLEANING:  { cls: 'badge-warning', label: 'Chờ dọn' },
    PENDING_REVIEW:    { cls: 'badge-warning', label: 'Chờ xem xét' },
    ESCALATED:         { cls: 'badge-error',   label: 'Leo thang' },
    REJECTED:          { cls: 'badge-error',   label: 'Từ chối' },
