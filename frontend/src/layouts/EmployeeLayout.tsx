...
const NAV_SECTIONS = [
  ...
  },
  {
    label: 'OPERATIONS',
    items: [
      { label: 'Housekeeping', path: '/employee/housekeeping', icon: IconHousekeeping },
      { label: 'Maintenance',  path: '/employee/maintenance',  icon: IconMaintenance },
      { label: 'Inspections',  path: '/employee/inspections',  icon: IconInspection },
      { label: 'Damage Reports', path: '/employee/damage',     icon: IconDamage },
      { label: 'Rooms',        path: '/employee/rooms',        icon: IconRoom },
    ],
  },
  {
    label: 'ACCOUNT',
    items: [
      { label: 'Notifications', path: '/employee/notifications', icon: IconNotif },
      { label: 'Profile',       path: '/employee/profile',       icon: IconProfile },
    ],
  },
];
...
function IconNotif()        { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>; }
function IconProfile()      { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>; }
...
export default function EmployeeLayout({ children }: { children: React.ReactNode }) {
  ...
  // Prefer longest matching path so /employee/damage/create still maps to Damage Reports
        ...
        <div className="px-3 pt-4 flex-shrink-0">
          <div className="flex items-center gap-3 px-3 py-3 rounded-xl" style={{ background: 'rgba(255,255,255,0.05)' }}>
            ...
            <div className="min-w-0">
              ...
              <p style={{ fontSize: 11, color: 'var(--on-dark-mute)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', marginTop: 1 }}>{email || 'Employee'}</p>
            </div>
          </div>
        </div>
