...
const NAV_SECTIONS = [
  ...
  },
  {
    label: 'MARKETING',
    items: [
      { label: 'Banner',           path: '/admin/promotions',       icon: IconPromotion },
      { label: 'About',            path: '/admin/about',            icon: IconAbout },
    ],
  },
  {
    label: 'REPORTING',
...
function IconAbout()      { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>; }
